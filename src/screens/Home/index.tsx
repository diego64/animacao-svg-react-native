...
import Animated, { useAnimatedProps, useSharedValue, interpolate, withTiming, withRepeat ,Easing } from 'react-native-reanimated';
...
export function Home() {
  ...
  const fristWaveProps = useAnimatedProps(() => {
    return {
      d:`
        M 0 0
  ...
  return (
    <View style={styles.container}>
      <Header ml={heightAnimated.value} percent={percentage} />

      <AnimatedSvg animatedProps={svgContainerProps}>
        <AnimatedPath 
          animatedProps={fristWaveProps}
          fill={theme.colors.blue100}
